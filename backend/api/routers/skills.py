...
MARKETPLACE_SKILLS: list[dict[str, Any]] = [
    ...
    },
    {
        "id": "skill-markitdown",
        "name": "万能文档转Markdown",
        "description": "PDF/图片/视频/Word/PPT/Excel 一键转 Markdown。案卷评查必备。",
        "version": "v1.0", "category": "document",
        "author": "EcoMind Lab", "downloads": 6800, "rating": 4.9,
        "tags": ["PDF", "OCR", "转换", "Markdown", "案卷"], "safety_level": "L1",
        "expert_ids": ["enforcement", "ecomind", "env-monitoring", "eia"],
    },
    {
        "id": "eco-case-review-full",
        "name": "案卷完整评查",
        "description": "生态环境行政处罚案卷8步完整评查流程：解析→合法性→规范性→裁量→证据→文书→综合分析→报告。基于2024年版评查细则。",
        "version": "v4.0", "category": "enforcement",
        "author": "xiejianjun000/eco-case-review", "downloads": 7200, "rating": 5.0,
        "tags": ["案卷", "评查", "执法", "合法性", "规范性"], "safety_level": "L2",
        "expert_ids": ["enforcement", "ecomind", "inspection"],
    },
    {
